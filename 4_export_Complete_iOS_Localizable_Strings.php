...
<head>
	...
	<title>Complete iOS Localizable Strings</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <script src="validations.js"></script>
    <script>
        function downloadLocalizableStrings() {
            ...
            if(self.validateForm()) {
                ...
                str_url = "4_download_Complete_iOS_Localizable_Strings.php?SelectedCard="+$selected_card+"&appversion="+$app_version;
                // alert(str_url);

                var win = window.open(str_url, '_blank');
                win.focus();
            }
        }
...
<form accept-charset="utf-8" name="form1" method="post">
    ...
    <? echo "<tr><td colspan=2 align=center><a id='generateButton' name='generateButton' onclick='downloadLocalizableStrings()'>Download All Localizable.strings</button></td></tr>"; ?>
</form>
</table>
</body>
</html>